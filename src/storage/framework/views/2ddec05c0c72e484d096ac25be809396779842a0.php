    ...
    <div class="col-md-8 col-md-offset-2">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form class="form-horizontal" method="POST" action="<?php echo e(url('reports/create')); ?>">
            ...
            <div class="form-group<?php echo e($errors->has('rp_content') ? ' has-error' : ''); ?>">
              ...
              <div class="col-md-6">
                <input id="rp_content" type="text" class="form-control" name="rp_content" value="<?php echo e(old('rp_content')); ?>" required>
