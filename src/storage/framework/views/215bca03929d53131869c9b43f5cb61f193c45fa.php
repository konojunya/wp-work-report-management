    ...
    <div class="col-md-8 col-md-offset-2">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form class="form-horizontal" method="POST" action="<?php echo e(url('create')); ?>">
            ...
            <div class="form-group<?php echo e($errors->has('rp_date') ? ' has-error' : ''); ?>" id="datepicker-default">
              ...
              <div class="col-md-6">
                <div class="input-group date">
                  <input id="rp_date" type="text" class="form-control" name="rp_date" value="<?php echo e(old('rp_date')); ?>" required autofocus>
            ...
            <div class="form-group<?php echo e($errors->has('rp_time_from') ? ' has-error' : ''); ?>">
              ...
              <div class="col-md-6">
                <input id="rp_time_from" type="time" class="form-control" name="rp_time_from" value="<?php echo e(old('rp_time_from')); ?>" required>
            ...
            <div class="form-group<?php echo e($errors->has('rp_time_to') ? ' has-error' : ''); ?>">
              ...
              <div class="col-md-6">
                <input id="rp_time_to" type="time" class="form-control" name="rp_time_to" value="<?php echo e(old('rp_time_to')); ?>" required>
              ...
              <div class="col-md-6">
                ...
                <select class="form-control" id="reportcate_id" name="reportcate_id" required>
                  <?php $__currentLoopData = $reportcates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reportcate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($reportcate['id']); ?>"><?php echo e($reportcate['rc_name']); ?></option>
            ...
            <div class="form-group<?php echo e($errors->has('rp_content') ? ' has-error' : ''); ?>">
              ...
              <div class="col-md-6">
                <textarea id="rp_content" type="text" class="form-control" name="rp_content" value="<?php echo e(old('rp_content')); ?>" required></textarea>
